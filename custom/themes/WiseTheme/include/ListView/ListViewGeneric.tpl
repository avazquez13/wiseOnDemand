...
{if $hideTable == false}
	...
	<thead>
		...
		{include file='custom/themes/WiseTheme/include/ListView/ListViewPaginationTop.tpl'}
	</thead>
	<tbody>
	...
	<tfoot>
    {include file='custom/themes/WiseTheme/include/ListView/ListViewPaginationBottom.tpl'}
	</tfoot>
	</table></div>
{/if}
{if $contextMenus}
