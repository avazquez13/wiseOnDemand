...
#actionMenuSidebar li a.side-bar-My_New_Icon {
    background-image: url("../../../..custom/themes/WiseTheme/images/sidebar/side-bar-My_New_Icon.png");
    background-image: url("../../../..custom/themes/WiseTheme/images/sidebar/side-bar-My_New_Icon.svg");
}